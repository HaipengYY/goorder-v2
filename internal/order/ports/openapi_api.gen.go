...
type ServerInterface interface {
	...
	GetCustomerCustomerIDOrders(c *gin.Context, customerID string)
...
// GetCustomerCustomerIDOrders operation middleware
func (siw *ServerInterfaceWrapper) GetCustomerCustomerIDOrders(c *gin.Context) {
	...
	siw.Handler.GetCustomerCustomerIDOrders(c, customerID)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.GET(options.BaseURL+"/customer/:customerID/orders", wrapper.GetCustomerCustomerIDOrders)
