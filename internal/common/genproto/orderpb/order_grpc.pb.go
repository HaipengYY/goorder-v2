...
const (
	OrderService_CreatOrder_FullMethodName  = "/orderpb.OrderService/CreatOrder"
...
type OrderServiceClient interface {
	CreatOrder(ctx context.Context, in *CreatOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *orderServiceClient) CreatOrder(ctx context.Context, in *CreatOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, OrderService_CreatOrder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	CreatOrder(context.Context, *CreatOrderRequest) (*emptypb.Empty, error)
...
func (UnimplementedOrderServiceServer) CreatOrder(context.Context, *CreatOrderRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatOrder not implemented")
}
...
func _OrderService_CreatOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreatOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).CreatOrder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_CreatOrder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).CreatOrder(ctx, req.(*CreatOrderRequest))
	}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreatOrder",
			Handler:    _OrderService_CreatOrder_Handler,
		},
		{
			MethodName: "GetOrder",
